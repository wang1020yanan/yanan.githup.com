    ...
    f.Util = {},
        ...
        f.Parse = function(r, i) {
            ...
            function E(e, t, n) {
                ...
                ct.trimText(t.nodeValue).length > 0 && (t.nodeValue = p(t.nodeValue, vt(e, "textTransform")), u = u.replace(["-webkit-auto"], ["auto"]), f = !i.letterRendering && /^(left|right|justify|auto)$/.test(u) && d(vt(e, "letterSpacing")) ? t.nodeValue.split(/(\b| )/) : t.nodeValue.split(""), a = m(r, e, o, s), i.chinese && f.forEach(function(e, t) { / . * [\u4E00 - \u9FA5]. * $ / .test(e) && (e = e.split(""), e.unshift(t, 1), f.splice.apply(f, e))
...
Animation = function() {
    ...
    Snowflakes = function() {
        ...
        var o = [],
            ...
            a = .1,
            f = 2,
            l = "http://www.uustudy.com.cn/index/Public/img/Snowflakes.png",
            c = [],
            h = 5,
            p = 20,
            d = 20,
