...
function Food(type, left, id){
	...
	this.left = left;
	this.top = -50;
	this.speed = 0.04 * Math.pow(1.35,Math.floor(gameMonitor.time/this.speedUpTime));
	this.loop = 0;
...
//            $('.btn1').text('在朋友圈晒分数').removeClass('playagain').addClass('share');
			alert("第一关通关成功，已登录后可以进入下一关");
			window.location.href="http://www.25to75.com/user/login";
        }
	},
	isMobile : function(){
