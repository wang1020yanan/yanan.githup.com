...
function Food(type, left, id){
	...
	this.left = left;
	this.top = -50;
	this.speed = 0.3 * Math.pow(1.35,Math.floor(gameMonitor.time/this.speedUpTime));
	this.loop = 0;
...
//            $('.sssq').removeClass('sssqyc');
            ...
            var urlMobile='http://www.25to75.com/weixin/hb_2_2';//手机跳转的页面//            小于30跳转到微信商城
...
//            $('.btn1').text('在朋友圈晒分数').removeClass('playagain').addClass('share');
			...
			window.location.href="http://www.25to75.com/weixin/hb_2_2";
        }
	},
	isMobile : function(){
