...
<div class="swiper-container">
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide" >
            <img src="<?php echo base_url()?>/public/image/h-1.jpg" style="width: 100%;height: 100%">
        </div>
        <!-- 第二屏-->
        <div class="swiper-slide" >
            <img src="<?php echo base_url()?>/public/image/h-2.jpg" style="width: 100%;height: 100%">
        </div>
        <!-- 第三屏-->

        <div class="swiper-slide" >
            <img src="<?php echo base_url()?>/public/image/h-3.jpg" style="width: 100%;height: 100%">
        </div>
        <!-- 第四屏-->

        <div class="swiper-slide">
            <img src="<?php echo base_url()?>/public/image/h-4.jpg" style="width: 100%;height: 100%">
        </div>
        <!-- 第五屏-->

        <div class="swiper-slide">
            <img src="<?php echo base_url()?>/public/image/h-5.jpg" style="width: 100%;height: 100%">
        </div>
    </div>
    <!--按钮-->
