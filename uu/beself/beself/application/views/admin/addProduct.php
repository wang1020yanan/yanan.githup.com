...
<div class="container" id="editor">
    <div class="row">
        ...
        <div class="col-md-12" style="border: 2px solid #858585">
            <form name="example" method="post" action="<?php echo site_url('admin/doAdd')?>" enctype="multipart/form-data">
                <div class="col-md-4" style="padding: 0">
                    <div class="col-md-12"><label>产品编号：<input type="text" name="number" id="number" ></label></div>
                    <div class="col-md-12"><label>产品名称：<input type="text" name="name" id="name" ></label></div>
                    <div class="col-md-12">
                        <label>
                            产品种类：
                    ...
                    <div class="col-md-12"><label>产品系列：<input type="text" name="series" id="series" ></label></div>
                    <div class="col-md-12"><label>产品价格：<input type="text" name="price" id="price" ></label></div>
                    <div class="col-md-12"><label>产品材质：<input type="text" name="material" id="material" ></label></div>
                    <div class="col-md-12"><label>产品石料：<input type="text" name="stone" id="stone" ></label></div>
                </div>
                ...
                <div class="col-md-12" style="margin-bottom: 50px">
                    <textarea name="content2" style="width:100%;height:400px;visibility:hidden;"></textarea>
                </div>
