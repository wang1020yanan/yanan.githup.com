...
(function(b) {
    var e = function(b) {
        ...
        a.prototype.push = function(c) {
            var l = this.objectPool; - 1 == l.indexOf(c) && (l.push(c), this._length++, 0 == this.frameCount && (this.frameCount = this.autoDisposeTime, a._callBackList.push(this)))
        };
...
(function(b) {
    var e = function(d) {
        ...
        a.prototype.addEventListener = function(c, a, h, d, e) {
            ...
            a || b.Logger.fatal("addEventListener渚﹀惉鍑芥暟涓嶈兘涓虹┖");
        ...
        a.prototype._insertEventBin = function(c, a, h, b, d) {
            ...
            for (var e = -1, k = c.length, m = 0; m < k; m++) {
                var p = c[m];
                if (p.listener === a && p.thisObject === h && p.display === d) return !1; - 1 == e && p.priority < b && (e = m)
            }
            a = {
                listener: a,
                thisObject: h,
        ...
        a.prototype.removeEventListener = function(c, a, h, b) {
            ...
            if (b = b ? this._captureEventsMap : this._eventsMap) {
                var d = b[c];
                d && (this._removeEventBin(d, a, h), 0 == d.length && delete b[c])
            }
        };
        a.prototype._removeEventBin = function(c, a, h, b) {
            ...
            for (var d = c.length, e = 0; e < d; e++) {
                var k = c[e];
                if (k.listener === a && k.thisObject === h && k.display === b) return c.splice(e, 1), !0
            }
            return !1
        };
...
(function(b) {
    var e = function(d) {
        ...
        a.prototype.broadcastRender = function() {
            ...
            for (var a = b.DisplayObject._renderCallBackList.concat(), h = a.length, d = 0; d < h; d++) {
                var e = a[d],
                    f = e.display;
                c._target = f;
                c._currentTarget = f;
    ...
    var e = function() {
        ...
        d.prototype.update = function(a) {
            ...
            if (this._totalDeltaTime >= this._maxDeltaTime) {
                ...
                var c = Math.ceil(this._logicPerformanceCost).toString() + "," + Math.ceil(this._updateTransformPerformanceCost).toString() + "," + Math.ceil(this._renderPerformanceCost).toString() + "," + Math.ceil(b.MainContext.instance.rendererContext.renderCost).toString();
...
(function(b) {
    var e = function(d) {
        ...
        a.prototype.setTimeout = function(c, a, h) {
            ...
            b.Logger.warning("Ticker#setTimeout鏂规硶鍗冲皢搴熷純,璇蜂娇鐢╡gret.setTimeout");
...
(function(b) {
    var e = function(d) {
        ...
        a.prototype.append = function(c, a, b, d, e, f) {
            var k = this.a,
                m = this.b,
                p = this.c,
                q = this.d;
        ...
        a.prototype.prependTransform = function(c, a, h, d, e, f, k, m, p) {
            ...
            } else q = 1, e = 0; if (m || p) this.tx -= m, this.ty -= p;
            f || k ? (this.prepend(q * h, e * h, -e * d, q * d, 0, 0), this.prepend(b.NumberUtils.cos(k), b.NumberUtils.sin(k), -b.NumberUtils.sin(f), b.NumberUtils.cos(f), c, a)) : this.prepend(q * h, e * h, -e * d, q * d, c, a);
            return this
        };
...
(function(b) {
    var e = function(d) {
        ...
        a.prototype.parserXML = function(c) {
            ...
            this._isSupportDOMParser ? a = this._parser.parseFromString(c, "text/xml") : (a = new ActiveXObject("Microsoft.XMLDOM"), a.async = "false", a.loadXML(c));
...
(function(b) {
    var e = function(c) {
        ...
        l.prototype.setDesignSize = function(c, a, l) {
            ...
            l && (b.Logger.warning("璇ユ柟娉曠洰鍓嶄笉搴斾紶鍏� resolutionPolicy 鍙傛暟锛岃鍦� docs/1.0_Final_ReleaseNote涓煡鐪嬪浣曞崌绾�"), this._setResolutionPolicy(l))
        };
    ...
    var e = function(d) {
        ...
        a.prototype.drawImage = function(c, a, h, d, e, f, k, m, p, q, r) {
            ...
            if (null != t && 0 != f && 0 != e && 0 != p && 0 != q) {
                ...
                } else c.drawImage(t, h, d, e, f, k, m, p, q, r)
            }
        };
...
(function(b) {
    var e = function() {
        ...
        d.getInstance = function(a, c) {
            ...
            throw Error("璋冪敤浜嗘湭閰嶇疆鐨勬敞鍏ヨ鍒�:" + l + "銆� 璇峰厛鍦ㄩ」鐩垵濮嬪寲閲岄厤缃寚瀹氱殑娉ㄥ叆瑙勫垯锛屽啀璋冪敤瀵瑰簲鍗曚緥銆�");
        };
        d.mapClassDic = {};
        d.mapValueDic = {};
        return d
...
(function(b) {
    var e = function(d) {
        ...
        Object.defineProperty(a.prototype, "scaleX", {
            ...
            set: function(c) {
                b.NumberUtils.isNumber(c) && this._scaleX != c && (this._scaleX = c, this._setDirty(), this._setParentSizeDirty())
            },
            enumerable: !0,
            configurable: !0
        });
        ...
        Object.defineProperty(a.prototype, "alpha", {
            ...
            set: function(c) {
                b.NumberUtils.isNumber(c) && this._alpha != c && (this._alpha = c, this._setDirty(), this._setCacheDirty())
            },
            enumerable: !0,
            configurable: !0
        });
        ...
        a.prototype.hitTest = function(c, a, h) {
            ...
            return 0 <= c && c < h.width && 0 <= a && a < h.height ? this.mask || this._scrollRect ? this._scrollRect && c > this._scrollRect.x && a > this._scrollRect.y && c < this._scrollRect.x + this._scrollRect.width && a < this._scrollRect.y + this._scrollRect.height || this.mask && this.mask.x <= c && c < this.mask.x + this.mask.width && this.mask.y <= a && a < this.mask.y + this.mask.height ? this : null : this : null
        };
        ...
        a.prototype.removeEventListener = function(c, l, h, e) {
            void 0 === e && (e = !1);
...
(function(b) {
    var e = function(d) {
        ...
        a.prototype.doSetChildIndex = function(c, a) {
            ...
            0 > h && b.Logger.fatal("child涓嶅湪褰撳墠瀹瑰櫒鍐�");
        ...
        a.prototype._doAddChild = function(c, l, h) {
            void 0 === h && (h = !0);
            if (c == this) return c;
            if (0 > l || l > this._children.length) return b.Logger.fatal("鎻愪緵鐨勭储寮曡秴鍑鸿寖鍥�"),
                c;
            var d = c._parent;
        ...
        a.prototype.swapChildrenAt = function(c, a) {
            0 <= c && c < this._children.length && 0 <= a && a < this._children.length ? this._swapChildrenAt(c, a) : b.Logger.fatal("鎻愪緵鐨勭储寮曡秴鍑鸿寖鍥�")
        };
        a.prototype.swapChildren = function(c, a) {
            var h = this._children.indexOf(c),
                d = this._children.indexOf(a); - 1 == h || -1 == d ? b.Logger.fatal("child鏈addChild鍒拌parent") : this._swapChildrenAt(h, d)
        };
            ...
            for (var c = 0, a = 0, h = 0, d = 0, e = this._children.length, f = 0; f < e; f++) {
                ...
                if (k._visible) {
                    var m = k.getBounds(b.Rectangle.identity, !1),
                        ...
                        m = m.height,
                        k = k._getMatrix(),
                        k = b.DisplayObject.getTransformBounds(b.Rectangle.identity.initialize(p, q, r, m), k),
                        p = k.x,
                        q = k.y,
                        r = k.width + k.x,
                        k = k.height + k.y;
        ...
        a.prototype.hitTest = function(c, a, h) {
            ...
            } else if (this.mask && (this.mask.x > c || c > this.mask.x + this.mask.width || this.mask.y > a || a > this.mask.y + this.mask.height)) return null;
        ...
        a.prototype._onAddToStage = function() {
            ...
            for (var c = this._children.length, a = 0; a < c; a++) this._children[a]._onAddToStage()
        };
        a.prototype._onRemoveFromStage = function() {
...
(function(b) {
    var e = function(d) {
        ...
        a.prototype.setResolutionPolicy = function() {
            ...
            c = c[this._scaleMode];
            if (!c) throw Error("浣跨敤浜嗗皻鏈疄鐜扮殑ScaleMode");
...
(function(b) {
    var e = function(d) {
        ...
        a.prototype.setContent = function(c) {
            this._content !== c && (this.removeContent(), c && (this._content = c, d.prototype.addChild.call(this, c), this._addEvents()))
        };
        ...
        Object.defineProperty(a.prototype, "horizontalScrollPolicy", {
            ...
            set: function(c) {
                c != this._horizontalScrollPolicy && (this._horizontalScrollPolicy = c)
            },
            enumerable: !0,
            configurable: !0
        });
        ...
        a.prototype._moveAfterTouchEnd = function() {
            if (0 != this._velocitys.length) {
                for (var c = 0, b = 0, d = 0, e = 0; e < this._velocitys.length; e++) var g = this._velocitys[e],
                    f = a.weight[e], c = c + g.x * f,
                    b = b + g.y * f, d = d + f;
        ...
        a.prototype.throwNotSupportedError = function() {
            throw Error("姝ゆ柟娉曞湪ScrollView鍐呬笉鍙敤!");
        };
        a.prototype.addChild = function(c) {
...
(function(b) {
    var e = function(d) {
        ...
        a.prototype._render = function(c) {
            var b = this._texture;
            b ? (this._texture_to_render = b, a._drawBitmap(c, this._hasWidthSet ? this._explicitWidth : b._textureWidth, this._hasHeightSet ? this._explicitHeight : b._textureHeight, this)) : this._texture_to_render = null
        };
            ...
            if (g) {
                ...
                if ("scale" == e.fillMode) {
                    ...
                    if (m && f - m.width < b && k - m.height < d) a.drawScale9GridImage(c, e, m, b, d);
                        ...
                        p = Math.round(p * d);
                        d = Math.round(r * d);
                        a.renderFilter.drawImage(c, e, g._bitmapX, g._bitmapY, q, r, m, p, b, d)
                    }
        ...
        a.drawScale9GridImage = function(c, a, d, e, g) {
            ...
            if (f && d) {
                ...
                var m = q + d.x,
                    ...
                    s = g - (s - d.bottom),
                    t = e - (t - d.right);
                k.drawImage(c, a, q / f, r / f, d.x, d.y, u, v, d.x, d.y);
...
(function(b) {
    var e = function(d) {
        ...
        Object.defineProperty(a.prototype, "spriteSheet", {
            ...
            set: function(c) {
                this._spriteSheet != c && (this._spriteSheet = c, this._spriteSheetChanged = !0, this._setSizeDirty())
            },
            enumerable: !0,
            configurable: !0
        });
        ...
        a.prototype._renderText = function(c) {
            ...
            for (var d = 0, e = this.text.length; d < e; d++) {
                ...
                if (null == f) console.log("褰撳墠娌℃湁浣嶅浘鏂囧瓧锛�" + g);
                else {
                    var g = f._offsetX,
                        k = f._offsetY,
                        m = f._textureWidth;
...
(function(b) {
    var e = function() {
        ...
        b.prototype.lineStyle = function(a, c, b, d, e, g, f, k) {};
...
(function(b) {
    var e = function(d) {
        ...
        a.prototype.setFocus = function() {
            b.Logger.warning("TextField.setFocus 娌℃湁瀹炵幇")
        };
        a.prototype._onRemoveFromStage = function() {
            d.prototype._onRemoveFromStage.call(this);
        ...
        a.prototype._getLinesArr = function() {
            ...
            if (this._hasWidthSet && 0 == this._explicitWidth) return console.warn("鏂囨湰瀹藉害琚缃负0"), this._numLines = 0, [{
                width: 0,
                height: 0,
                elements: []
            }];
                ...
                for (var q = p.text.toString().split(/(?:\r\n|\r|\n)/), r = 0; r < q.length; r++) {
                    ...
                    if ("" != q[r]) {
                        ...
                        if (this._hasWidthSet)
                            if (e + t <= this._explicitWidth) k.elements.push({
                                width: t,
                                text: q[r],
                                style: p.style
                            }), e += t;
...
(function(b) {
    var e = function(d) {
        ...
        a.prototype._updateTransform = function() {
            ...
            if (this._isFirst || c != k.a || a != k.b || d != k.c || e != k.d || g != k.tx || f != k.ty) {
                this._isFirst = !1;
                c = this._text.localToGlobal();
...
(function(b) {
    var e = function(a) {
        function c(c, e) {
            a.call(this);
            this.frameRate = 60;
            c instanceof d ? (b.Logger.warning("MovieClip#constructor鎺ュ彛鍙傛暟宸茬粡鍙樻洿锛岃灏藉揩璋冩暣鐢ㄦ硶涓� new MovieClip(data,texture)"), this.delegate = c) : this.delegate = new d(c, e);
        ...
        c.prototype.release = function() {
            b.Logger.warning("MovieClip#release鏂规硶鍗冲皢搴熷純");
            this.dispose()
        };
        c.prototype.getCurrentFrameIndex = function() {
            b.Logger.warning("MovieClip#getCurrentFrameIndex鏂规硶鍗冲皢搴熷純");
            return this.delegate._currentFrameIndex
        };
        c.prototype.getTotalFrame = function() {
            b.Logger.warning("MovieClip#getTotalFrame鏂规硶鍗冲皢搴熷純");
            return this.delegate._totalFrame
        };
        c.prototype.setInterval = function(a) {
            b.Logger.warning("MovieClip#setInterval鏂规硶鍗冲皢搴熷純,璇蜂娇鐢∕ovieClip#frameRate浠ｆ浛");
            this.frameRate = 60 / a
        };
        c.prototype.getIsPlaying = function() {
            b.Logger.warning("MovieClip#getIsPlaying鏂规硶鍗冲皢搴熷純");
    ...
    var d = function() {
        ...
        a.prototype.checkHasFrame = function(a) {
            void 0 == this._frameData.frames[a] && b.Logger.fatal("MovieClip娌℃湁瀵瑰簲鐨刦rame锛�", a)
        };
...
(function(b) {
    var e = function(d) {
        ...
        a.prototype.drawToTexture = function(c) {
            ...
            if (0 == e.width || 0 == e.height) return b.Logger.warning("egret.RenderTexture#drawToTexture:鏄剧ず瀵硅薄娴嬮噺缁撴灉瀹介珮涓�0锛岃妫€鏌�"), !1;
...
(function(b) {
    var e = function(d) {
        ...
        a.prototype.drawText = function(a, b, d, e, g, f) {
            this.profiler.onDrawImage()
        };
...
(function(b) {
    var e = function(d) {
        ...
        a.prototype.onTouchEnd = function(a, d, e) {
            var n = this.touchingIdentifiers.indexOf(e); - 1 != n && (this.touchingIdentifiers.splice(n, 1), n = b.MainContext.instance.stage.hitTest(a, d)) && (a = this.getTouchData(e, a, d), delete this.touchDownTarget[e], e = a.beginTarget, a.target = n, this.dispatchEvent(b.TouchEvent.TOUCH_END, a), e == n ? this.dispatchEvent(b.TouchEvent.TOUCH_TAP, a) : a.beginTarget && (a.target = a.beginTarget, this.dispatchEvent(b.TouchEvent.TOUCH_RELEASE_OUTSIDE, a)), delete this._currentTouchTarget[a.identifier])
        };
        return a
    }(b.HashObject);
    b.TouchContext = e;
...
(function(b) {
    var e = function(d) {
        ...
        Object.defineProperty(a.prototype, "isMobile", {
            get: function() {
                b.Logger.warning("Browser.isMobile鎺ュ彛鍙傛暟宸茬粡鍙樻洿锛岃灏藉揩璋冩暣鐢ㄦ硶涓� egret.MainContext.deviceType == egret.MainContext.DEVICE_MOBILE ");
        ...
        a.prototype.$ = function(c) {
            var d = document;
            if (c = c instanceof HTMLElement ? c : d.querySelector(c)) c.find = c.find || this.$, c.hasClass = c.hasClass || function(a) {
...
(function(b) {
    var e = function() {
        ...
        d.parseNode = function(a) {
            ...
            e = b.length;
            for (n = 0; n < e; n++)
                if (g = d.parseNode(b[n])) c.children || (c.children = []), g.parent = c, c.children.push(g);
        ...
        d.findByPath = function(a, c, b) {
            ...
            if (a = a.children)
                for (var g = a.length, f = 0; f < g; f++) {
                    var k = a[f];
                    k.localName == n && (e ? b.push(k) : d.findByPath(k, c, b))
                }
        };
    ...
    var d = function() {
        ...
        a.prototype.readUTFBytes = function(a) {
            ...
            for (var d = new DataView(this.arraybytes); this.position < a;) {
                ...
                else if (240 > e) var g = d.getUint8(this.position++),
                    b = b + String.fromCharCode((e & 31) << 12 | (g & 127) << 6 | d.getUint8(this.position++) & 127);
                else var g = d.getUint8(this.position++),
                        f = d.getUint8(this.position++), b = b + String.fromCharCode((e & 15) << 18 | (g & 127) << 12 | f << 6 & 127 | d.getUint8(this.position++) & 127)
            }
            return b
        };
...
(function(b) {
    var e = function(d) {
        ...
        a.removeTweens = function(c) {
            if (c.tween_count) {
                for (var b = a._tweens, d = b.length - 1; 0 <= d; d--) b[d]._target == c && (b[d].paused = !0, b.splice(d, 1));
                c.tween_count = 0
            }
        };
        ...
        a.tick = function(c, b) {
            ...
            for (var d = a._tweens.concat(), e = d.length - 1; 0 <= e; e--) {
                var g = d[e];
                b && !g.ignoreGlobalPause || g.paused || g.tick(g._useTicks ? 1 : c)
            }
        };
        ...
        a.prototype.initialize = function(c, b, d) {
            this._target = c;
            b && (this._useTicks = b.useTicks, this.ignoreGlobalPause = b.ignoreGlobalPause, this.loop = b.loop, b.onChange && this.addEventListener("change", b.onChange, b.onChangeObj), b.override && a.removeTweens(c));
            this.pluginData = d || {};
            this._curQueueProps = {};
        ...
        a.prototype._appendQueueProps = function(c) {
            ...
            for (k in c)
                if (void 0 === this._initQueueProps[k]) {
                    d = this._target[k];
                    if (b = a._plugins[k])
                        for (e = 0, g = b.length; e < g; e++) d = b[e].init(this, k, d);
                    this._initQueueProps[k] = this._curQueueProps[k] = void 0 === d ? null : d
                }
            for (k in c) {
                d = this._curQueueProps[k];
                if (b = a._plugins[k])
                    for (f = f || {}, e = 0, g = b.length; e < g; e++) b[e].step && b[e].step(this, k, d, c[k], f);
    ...
    var e = function() {
        ...
        d.getElasticIn = function(a, c) {
            ...
            return function(d) {
                ...
                return -(a * Math.pow(2, 10 * (d -= 1)) * Math.sin((d - e) * b / c))
            }
        };
            ...
            if (a) {
                ...
                if (b = a.groups)
                    for (d = b.length, e = 0; e < d; e++) {
                        for (var f = b[e], k = [], m = f.keys.split(","), p = m.length, q = 0; q < p; q++) g = m[q].trim(), (g = this.keyMap[g]) && -1 == k.indexOf(g) && k.push(g);
    ...
    var e = function(d) {
        ...
        a.prototype.loadGroup = function(a, d, e) {
            ...
            if (!this.itemListDic[d] && d)
                if (a && 0 != a.length) {
                    ...
                    this.next()
                } else egret.Logger.warning('RES鍔犺浇浜嗕笉瀛樺湪鎴栫┖鐨勮祫婧愮粍锛�"' + d + '"'), a = new b.ResourceEvent(b.ResourceEvent.GROUP_LOAD_ERROR), a.groupName = d, this.dispatchEvent(a)
        };
        ...
        a.prototype.onItemComplete = function(a) {
            ...
            if (!a.loaded) {
                ...
                if (e > this.maxRetryTimes) delete this.retryTimesDic[a.name], b.ResourceEvent.dispatchResourceEvent(this.resInstance, b.ResourceEvent.ITEM_LOAD_ERROR, d, a);
                else {
    ...
    var e = function(b) {
        ...
        a.prototype.analyzeData = function(a, b) {
            ...
            if (!this.fileDic[d] && b) try {
                ...
                egret.Logger.warning("JSON鏂囦欢鏍煎紡涓嶆纭�: " + a.url + "\ndata:" + b)
            }
        };
        return a
    }(b.BinAnalyzer);
...
(function(b) {
    var e = function(d) {
        ...
        a.prototype.parseSpriteSheet = function(a, b, d) {
            ...
            for (f in b) {
                var k = b[f];
                a = e.createTexture(f, k.x, k.y, k.w, k.h, k.offX, k.offY, k.sourceW, k.sourceH);
...
(function(b) {
    ...
    b.getResByUrl = function(a, b, e, h) {
        void 0 === h && (h = "");
    ...
    var e = function(a) {
        ...
        c.prototype.onGroupComp = function(a) {
            if (a.groupName == c.GROUP_CONFIG) {
                ...
                a = e.length;
                for (d = 0; d < a; d++) g = e[d], this.loadGroup(g.name, g.priority);
                this.groupNameList = []
...
(function(b) {
    ...
    b.setItem = function(b, d) {
        try {
            ...
            return console.log("egret_html5_localStorage.setItem淇濆瓨澶辫触,key=" + b + "&value=" + d), !1
        }
    };
    b.removeItem = function(b) {
        ...
        a.prototype.drawRepeatImage = function(a, d, e, n, g, f, k, m, p, q) {
            if (void 0 === a.pattern) {
                var r = b.MainContext.instance.rendererContext.texture_scale_factor,
                    t = a._bitmapData,
                    s = t;
                if (t.width != n || t.height != g || 1 != r) s = document.createElement("canvas"), s.width = n * r, s.height = g * r, s.getContext("2d").drawImage(t, d, e, n, g, 0, 0, n * r, g * r);
...
(function(b) {
    var e = function(d) {
        function a(a) {
            ...
            for (var e = 0, h = 0; e < a; e += 6, h += 4) this.indices[e + 0] = h + 0, this.indices[e + 1] = h + 1, this.indices[e + 2] = h + 2, this.indices[e + 3] = h + 0, this.indices[e + 4] = h + 2, this.indices[e + 5] = h + 3;
            this.initWebGL();
        ...
        a.prototype.initWebGL = function() {
            ...
            if (!b) throw Error("褰撳墠娴忚鍣ㄤ笉鏀寔webgl");
            this.setContext(b)
        };
        ...
        a.prototype.drawImage = function(a, b, d, e, g, f, k, m, p, q) {
            void 0 === q && (q = void 0);
            if (!this.contextLost)
                if (void 0 !== q) this.drawRepeatImage(a, b, d, e, g, f, k, m, p, q);
                else {
...
(function(b) {
    var e = function() {
        ...
        b.compileProgram = function(a, c, e) {
            ...
            a.attachShader(h, e);
            a.linkProgram(h);
            a.getProgramParameter(h, a.LINK_STATUS) || console.log("鏃犳硶鍒濆鍖栫潃鑹插櫒");
            return h
        };
    ...
    var e = function(d) {
        ...
        a.prototype.proceed = function(a) {
            ...
            if (a.dataFormat == b.URLLoaderDataFormat.TEXTURE) this.loadTexture(a);
                ...
                e.method != b.URLRequestMethod.GET && e.data ? e.data instanceof b.URLVariables ? (n.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), n.send(e.data.toString())) : (n.setRequestHeader("Content-Type", "multipart/form-data"), n.send(e.data)) : n.send()
            }
        };
...
(function(b) {
    var e = function(d) {
        ...
        a.prototype.getLocation = function(a, d) {
            ...
            null != d.pageX ? (e = d.pageX, n = d.pageY) : (g -= document.body.scrollLeft, f -= document.body.scrollTop, e = d.clientX, n = d.clientY);
...
var __extends = this.__extends || function(b, e) {
    ...
    e.prototype.startGame = function(b) {
        ...
        null == this.homePage && (b = XiaobinTool.createBitmapByName("startPanel_png"), this.addChild(b), b.x = (this.stageW - b.width) / 2, b.y = 560, b = XiaobinTool.createBitmapByName("homepageLight_png"), this.addChild(b), b.anchorOffsetX = b.width / 2, b.anchorOffsetY = -0, b.x = this.stageW / 2, b.y = 0, b.rotation = -20, egret.Tween.get(b, {
            ...
            rotation: -20
        }, 1500).wait(0), b = XiaobinTool.createBitmapByName("title_png"), this.addChild(b), b.x = (this.stageW - b.width) / 2, b.y = 20, b = XiaobinTool.createBitmapByName("logo_png"), this.addChild(b), b.x = (this.stageW - b.width) / 2, b.y = this.stageH - b.height, this.startBtn = new StartBtn, this.addChild(this.startBtn), this.startBtn.x = (this.stageW - this.startBtn.width) / 2, this.startBtn.y = 580, this.startBtn.touchEnabled = !0, this.startBtn.addEventListener(egret.TouchEvent.TOUCH_BEGIN, this.onTouchBegin, this));
        this.touchEnabled = !0
    };
    e.prototype.doHelp = function(b) {
        null == this.helpMc && (this.helpMc = XiaobinTool.creatMovieClip("pageMc_json", "pageMc_png", "yd1"), this.addChild(this.helpMc), this.upBtn = XiaobinTool.createBitmapByName("up_png"), this.addChild(this.upBtn), this.upBtn.x = 20, this.upBtn.y = 760, this.upBtn.touchEnabled = !0, this.downBtn = XiaobinTool.createBitmapByName("down_png"), this.addChild(this.downBtn), this.downBtn.x = 20, this.downBtn.y = this.upBtn.y, this.downBtn.touchEnabled = !0, this.backBtn = XiaobinTool.createBitmapByName("back_png"), this.addChild(this.backBtn), this.backBtn.x = this.stageW - this.downBtn.width - 20, this.backBtn.y = this.upBtn.y, this.backBtn.touchEnabled = !0, this.upBtn.visible = !1, this.downBtn.visible = !0, this.upBtn.addEventListener(egret.TouchEvent.TOUCH_BEGIN, this.doUp, this), this.downBtn.addEventListener(egret.TouchEvent.TOUCH_BEGIN, this.doDown, this), this.backBtn.addEventListener(egret.TouchEvent.TOUCH_BEGIN, this.doBack, this))
    };
...
var __extends = this.__extends || function(b, e) {
    ...
    e.prototype.moveDeng = function() {
        for (var b = 0; b < this.dengArr.length; b++) {
            var a = this.dengArr[b];
            a.y > this.stageH / 2 ? (a.x += this.x_speedArr[b], 50 > a.x && (a.x = 50), 430 < a.x && (a.x = 430)) : (a.alpha -= 0.003, 0 > a.alpha && (a.alpha = 0));
            a.scaleX -= 0.003;
            a.scaleY -= 0.003;
    ...
    e.prototype.creatPoint = function() {
        ...
        this.p.alpha = 0.001;
        this.p.anchorOffsetX = this.p.width / 2;
    ...
    e.prototype.makeGameOver = function() {
        ...
        var mescore=GameOverPanel.scoreNum;
        var mefont="涓�";
        var melevel="";
        Getscore(mescore,1191,mefont,melevel);
...
var __extends = this.__extends || function(b, e) {
    ...
    e.prototype.onResourceLoadComplete = function(b) {
        "preload" == b.groupName && (RES.removeEventListener(RES.ResourceEvent.GROUP_COMPLETE, this.onResourceLoadComplete, this), this.createPic(), this.createText(), this.createShape())
    };
